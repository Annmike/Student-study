        ...
        int falg = 0;
            try {
                if (rs.next()) {
                    ...
                    sql = "INSERT INTO tb_questions (id,subject,type,joinTime,lessonId,taoTiId,optionA,optionB,optionC,optionD,answer,note) values(null,'" +
                                 q.getSubject() + "','"+q.getType()+"',now(),"+q.getLessonId()+","+q.getTaoTiId()+",'"+q.getOptionA()+"','"+q.getOptionB()+"','"+q.getOptionC()+"','"+q.getOptionD()+"','"+answer+"','"+q.getNote()+"')";
