...
public class LessonDAO {
    ...
    public List query(String studentID) {
    	List lessonList = new ArrayList();
        LessonForm lessonForm1 = null;
        String sql="SELECT * FROM tb_lesson WHERE ID in(SELECT LessonID FROM tb_Taoti)AND Name not in(SELECT distinct whichLesson FROM tb_stuResult WHERE stuId='"+studentID+"')";
